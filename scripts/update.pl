...
@keepvac = ('1st dose 12-15 %','1st dose 16-17 %','1st dose 18-24 %','1st dose 25-29 %','1st dose 30-34 %','1st dose 35-39 %','1st dose 40-44 %','1st dose 45-49 %','1st dose 50-54 %','1st dose 55-59 %','1st dose 60-64 %','1st dose 65-69 %','1st dose 70-74 %','1st dose 75-79 %','1st dose 80+ %','2nd dose Under 18 %','2nd dose 18-24 %','2nd dose 25-29 %','2nd dose 30-34 %','2nd dose 35-39 %','2nd dose 40-44 %','2nd dose 45-49 %','2nd dose 50-54 %','2nd dose 55-59 %','2nd dose 60-64 %','2nd dose 65-69 %','2nd dose 70-74 %','2nd dose 75-79 %','2nd dose 80+ %','3rd dose 40-44 %','3rd dose 45-49 %','3rd dose 50-54 %','3rd dose 55-59 %','3rd dose 60-64 %','3rd dose 65-69 %','3rd dose 70-74 %','3rd dose 75-79 %','3rd dose 80+ %','Vaccine notes');
...
foreach $msoa (sort(keys(%vaccines))){
	...
	if($msoa !~ /^[ENSW][0-9]{8}$/){
		...
		for($m = 0; $m < @msoas;$m++){
			...
			$vaccines{$msoas[$m]}{'Vaccine notes'} = "Combined figures for $msoa";
		}
	}
