...
(function(root){
	...
	var options = {
		...
		"1st dose 12-15 %":{"format":function(v,props){ if(v==""){ return "{{n}}<br />Figures suppressed due to small numbers"; }else{ return "{{n}}<br />{{v}}% (as of {{Vac date}})<br />{{Vaccine notes}}"; }},"range":[0,100]},
		"1st dose 16-17 %":{"format":function(v,props){ if(v==""){ return "{{n}}<br />Figures suppressed due to small numbers"; }else{ return "{{n}}<br />{{v}}% (as of {{Vac date}})<br />{{Vaccine notes}}"; }},"range":[0,100]},
		...
		"2nd dose 12-15 %":{"format":function(v,props){ if(v==""){ return "{{n}}<br />Figures suppressed due to small numbers"; }else{ return "{{n}}<br />{{v}}% (as of {{Vac date}})<br />{{Vaccine notes}}"; }},"range":[0,100]},
		"2nd dose 16-17 %":{"format":function(v,props){ if(v==""){ return "{{n}}<br />Figures suppressed due to small numbers"; }else{ return "{{n}}<br />{{v}}% (as of {{Vac date}})<br />{{Vaccine notes}}"; }},"range":[0,100]},
		...
		"3rd dose 12-15 %":{"format":function(v,props){ if(v==""){ return "{{n}}<br />Figures suppressed due to small numbers"; }else{ return "{{n}}<br />{{v}}% (as of {{Vac date}})<br />{{Vaccine notes}}"; }},"range":[0,100]},
		"3rd dose 16-17 %":{"format":function(v,props){ if(v==""){ return "{{n}}<br />Figures suppressed due to small numbers"; }else{ return "{{n}}<br />{{v}}% (as of {{Vac date}})<br />{{Vaccine notes}}"; }},"range":[0,100]},
		"3rd dose 40-44 %":{"format":function(v,props){ if(v==""){ return "{{n}}<br />Figures suppressed due to small numbers"; }else{ return "{{n}}<br />{{v}}% (as of {{Vac date}})<br />{{Vaccine notes}}"; }},"range":[0,100]},
		"3rd dose 45-49 %":{"format":function(v,props){ if(v==""){ return "{{n}}<br />Figures suppressed due to small numbers"; }else{ return "{{n}}<br />{{v}}% (as of {{Vac date}})<br />{{Vaccine notes}}"; }},"range":[0,100]},
		"3rd dose 50-54 %":{"format":function(v,props){ if(v==""){ return "{{n}}<br />Figures suppressed due to small numbers"; }else{ return "{{n}}<br />{{v}}% (as of {{Vac date}})<br />{{Vaccine notes}}"; }},"range":[0,100]},
		"3rd dose 55-59 %":{"format":function(v,props){ if(v==""){ return "{{n}}<br />Figures suppressed due to small numbers"; }else{ return "{{n}}<br />{{v}}% (as of {{Vac date}})<br />{{Vaccine notes}}"; }},"range":[0,100]},
		"3rd dose 60-64 %":{"format":function(v,props){ if(v==""){ return "{{n}}<br />Figures suppressed due to small numbers"; }else{ return "{{n}}<br />{{v}}% (as of {{Vac date}})<br />{{Vaccine notes}}"; }},"range":[0,100]},
		"3rd dose 65-69 %":{"format":function(v,props){ if(v==""){ return "{{n}}<br />Figures suppressed due to small numbers"; }else{ return "{{n}}<br />{{v}}% (as of {{Vac date}})<br />{{Vaccine notes}}"; }},"range":[0,100]},
		"3rd dose 70-74 %":{"format":function(v,props){ if(v==""){ return "{{n}}<br />Figures suppressed due to small numbers"; }else{ return "{{n}}<br />{{v}}% (as of {{Vac date}})<br />{{Vaccine notes}}"; }},"range":[0,100]},
		"3rd dose 75-79 %":{"format":function(v,props){ if(v==""){ return "{{n}}<br />Figures suppressed due to small numbers"; }else{ return "{{n}}<br />{{v}}% (as of {{Vac date}})<br />{{Vaccine notes}}"; }},"range":[0,100]},
		"3rd dose 80+ %":{"format":function(v,props){ if(v==""){ return "{{n}}<br />Figures suppressed due to small numbers"; }else{ return "{{n}}<br />{{v}}% (as of {{Vac date}})<br />{{Vaccine notes}}"; }},"range":[0,100]},
